...
<div class="row servicerow">
    ...
    <div class="col col-lg-5 col-md-5 col-sm-12" style={{backgroundColor:'darkslateBlue ', border:'5px solid dodgerBlue' ,justifyContent:'center',alignItems:'center',margin:'auto',marginTop:'20vh',marginBottom:'20vh'}}>

    
        <div class="text-center touch" style={{marginTop:'5vh'}} >
          <h2 style={{color:'white'}}>Contact US</h2>
          </div>
        <form>
        <div class="form-group">
    
        <input type="text" class="form-control" id="exampleInputName1" placeholder="Enter Your Name" style={{backgroundColor:'transparent', border:'none',borderBottom:'2px solid dodgerBlue',marginTop:'-5vh'}}/>
        </div>
        <div class="form-group">
          <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email"  style={{backgroundColor:'transparent', border:'none',borderBottom:'2px solid dodgerBlue',color:'dodgerblue'}}/>
        ...
        <div class="form-group">
          ...
          <input type="password" class="form-control" id="exampleInputPassword1" placeholder="Enter Your Password"  style={{backgroundColor:'transparent', border:'none',borderBottom:'2px solid dodgerBlue',color:'dodgerBlue'}}/>
          </div>
        <div class="form-group">
        <textarea class="form-control" id="exampleFormControlTextarea1" rows="4" placeholder='Message'  style={{backgroundColor:'transparent', border:'none',borderBottom:'2px solid dodgerBlue',color:'dodgerBlue'}}></textarea>
        </div>
